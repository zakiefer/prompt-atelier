...
export function buildLearnerExportTargetMatrix({
  ...
  const rows = [
    ...
    { target: "Raw Spec", useFor: "Neutral implementation", include: "Portable requirements, acceptance gates, and non-goals.", avoid: "Tool-specific assumptions.", ready: presetIds.has("raw") },
    { target: "JSONL", useFor: "Fine-tune row", include: "Messages, scorecard metadata, and proof-required label.", avoid: "Secrets or unrelated project data.", ready: presetIds.has("jsonl") },
